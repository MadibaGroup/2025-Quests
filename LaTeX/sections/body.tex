...
%While future studies could analyze multiple quest systems, our findings are broadly applicable. Our dataset covers a wide range of quest types—DeFi, NFTs, social, gaming, and transfers—ensuring relevance across blockchain ecosystems. It includes varying difficulties, cost levels, and participation thresholds, making it applicable to both expensive and low-cost chains. The study also spans pre- and post-airdrop phases, capturing shifts in user motivation. Finally, by analyzing both points-based and token-based rewards, we cover the primary incentive models used in blockchain loyalty programs. However, the evolving nature of AI-driven automation introduces uncertainty over time. As Walters et al. (2025) highlight, on-chain AI agents like ElizaOS can autonomously execute transactions, interact with smart contracts, and manage wallets, mirroring quest completion actions. With AI-generated code simplifying bot creation, future research must explore how automation will impact Web3 loyalty programs.
